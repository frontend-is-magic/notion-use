...
6. AI 写一句话总结、正文和折叠细节，按规则选择文风和画面。指定 documentType，按 2000–5000 字/有效图规划正文插图，脚本 `lint`/illustrationAudit 校验；生成并上传图标、封面。AI 决策用 JSON 保存到本次 `work/`，记录选择理由和父 ID，不记录凭据。
